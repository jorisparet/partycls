...
It can readily analyze trajectories generated by molecular dynamics simulation software, both within particle-based and multi-scale approaches (see [@Guzman_Tretyakov_Kobayashi_Fogarty_Kreis_Krajniak_Junghans_Kremer_Stuehn_2019] and references therein), but also experimental data obtained with confocal microscope techniques [@Weeks_Crocker_Levitt_Schofield_Weitz_2000].
